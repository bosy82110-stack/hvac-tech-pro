...
const FIELDS = [
  ["الماركة", "brand", "Brand / Manufacturer", "اسم الشركة المصنعة للجهاز."], ["الموديل", "model", "Model / Model Name", "رقم أو اسم طراز الجهاز."], ["موديل الوحدة الداخلية", "indoorModel", "Indoor Unit Model", "طراز الوحدة الداخلية."], ["موديل الوحدة الخارجية", "outdoorModel", "Outdoor Unit Model", "طراز الوحدة الخارجية، وهو الأكثر ظهورًا على اللوحة الخارجية."],
  ["الرقم التسلسلي", "serial", "Serial Number / S/N", "رقم تعريف فريد للجهاز يُستخدم للضمان والصيانة."], ["تاريخ التصنيع", "manufactureDate", "MFG Date / Date of Manufacture", "تاريخ إنتاج الجهاز."], ["نوع الفريون", "refrigerant", "Refrigerant", "نوع وسيط التبريد المستخدم في الدائرة."], ["السعة BTU", "btu", "Capacity / BTU/hr", "قدرة الجهاز الحرارية، وغالبًا تكتب بوحدة BTU في الساعة."],
  ["سعة التبريد", "coolingCapacity", "Cooling Capacity", "كمية الحرارة التي يستطيع الجهاز سحبها أثناء التبريد."], ["سعة التدفئة", "heatingCapacity", "Heating Capacity", "كمية الحرارة التي يضيفها الجهاز أثناء التدفئة."], ["جهد التشغيل", "voltage", "Rated Voltage / Power Supply", "الجهد الكهربائي الاسمي المطلوب لتشغيل الجهاز."], ["عدد الفازات", "phase", "Phase / Ph", "عدد الفازات الكهربائية، مثل 1 Ph أو 3 Ph."],
  ["التردد", "frequency", "Rated Frequency", "تردد مصدر الكهرباء، ويقاس بالهرتز مثل 50 أو 60 Hz."], ["تيار التبريد", "coolingCurrent", "Cooling Current / Cooling Amps", "التيار الذي يسحبه الجهاز أثناء وضع التبريد."], ["تيار التدفئة", "heatingCurrent", "Heating Current / Heating Amps", "التيار الذي يسحبه الجهاز أثناء وضع التدفئة."], ["الأمبير", "ampere", "Current / Rated Current", "قيمة التيار الاسمية أو تيار التشغيل حسب العنوان الموجود على اللوحة."],
  ["قدرة دخل التبريد", "coolingPower", "Cooling Power Input", "القدرة الكهربائية التي يستهلكها الجهاز أثناء التبريد."], ["قدرة دخل التدفئة", "heatingPower", "Heating Power Input", "القدرة الكهربائية التي يستهلكها الجهاز أثناء التدفئة."], ["القدرة", "power", "Power Input / Input Power", "القدرة الكهربائية الداخلة إلى الجهاز، وتقاس بالواط أو الكيلوواط."], ["EER", "eer", "EER", "نسبة كفاءة التبريد؛ كلما زادت عادةً كان استهلاك التبريد أفضل."], ["COP", "cop", "COP", "معامل أداء التدفئة؛ يقارن قدرة التدفئة بالطاقة الكهربائية المستهلكة."],
  ["وزن الشحنة", "charge", "Refrigerant Charge / Quantity", "كمية الفريون داخل النظام، وتقاس غالبًا بالجرام أو الكيلوجرام."], ["ضغط التشغيل الأقصى", "maxPressure", "Max Operating Pressure / Max Pressure", "أقصى ضغط تصميمي أو مسموح به، وقد يذكر لضغطي الطرد والسحب."], ["درجة الحماية IP", "ipRating", "IP Rating / Water Proof", "درجة حماية جسم الجهاز من الماء والأجسام الصلبة، مثل IPX4."], ["وزن الوحدة الداخلية", "indoorWeight", "Indoor Unit Weight", "وزن الوحدة الداخلية."], ["وزن الوحدة الخارجية", "outdoorWeight", "Outdoor Unit Weight", "وزن الوحدة الخارجية."],
] as const;
