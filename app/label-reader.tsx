...
const FIELDS = [
  ["Brand / Manufacturer (الماركة)", "brand", "Brand / Manufacturer", "اسم الشركة المصنعة للجهاز."], ["Model / Model Name (الموديل)", "model", "Model / Model Name", "رقم أو اسم طراز الجهاز."], ["Indoor Unit Model (موديل الوحدة الداخلية)", "indoorModel", "Indoor Unit Model", "طراز الوحدة الداخلية."], ["Outdoor Unit Model (موديل الوحدة الخارجية)", "outdoorModel", "Outdoor Unit Model", "طراز الوحدة الخارجية، وهو الأكثر ظهورًا على اللوحة الخارجية."],
  ["Serial Number / S/N (الرقم التسلسلي)", "serial", "Serial Number / S/N", "رقم تعريف فريد للجهاز يُستخدم للضمان والصيانة."], ["MFG Date / Date of Manufacture (تاريخ التصنيع)", "manufactureDate", "MFG Date / Date of Manufacture", "تاريخ إنتاج الجهاز."], ["Refrigerant (نوع الفريون)", "refrigerant", "Refrigerant", "نوع وسيط التبريد المستخدم في الدائرة."], ["Capacity / BTU/hr (السعة BTU)", "btu", "Capacity / BTU/hr", "قدرة الجهاز الحرارية، وغالبًا تكتب بوحدة BTU في الساعة."],
  ["Cooling Capacity (سعة التبريد)", "coolingCapacity", "Cooling Capacity", "كمية الحرارة التي يستطيع الجهاز سحبها أثناء التبريد."], ["Heating Capacity (سعة التدفئة)", "heatingCapacity", "Heating Capacity", "كمية الحرارة التي يضيفها الجهاز أثناء التدفئة."], ["Rated Voltage / Power Supply (جهد التشغيل)", "voltage", "Rated Voltage / Power Supply", "الجهد الكهربائي الاسمي المطلوب لتشغيل الجهاز."], ["Phase / Ph (عدد الفازات)", "phase", "Phase / Ph", "عدد الفازات الكهربائية، مثل 1 Ph أو 3 Ph."],
  ["Rated Frequency (التردد)", "frequency", "Rated Frequency", "تردد مصدر الكهرباء، ويقاس بالهرتز مثل 50 أو 60 Hz."], ["Cooling Current / Cooling Amps (تيار التبريد)", "coolingCurrent", "Cooling Current / Cooling Amps", "التيار الذي يسحبه الجهاز أثناء وضع التبريد."], ["Heating Current / Heating Amps (تيار التدفئة)", "heatingCurrent", "Heating Current / Heating Amps", "التيار الذي يسحبه الجهاز أثناء وضع التدفئة."], ["Current / Rated Current (الأمبير)", "ampere", "Current / Rated Current", "قيمة التيار الاسمية أو تيار التشغيل حسب العنوان الموجود على اللوحة."],
  ["Cooling Power Input (قدرة دخل التبريد)", "coolingPower", "Cooling Power Input", "القدرة الكهربائية التي يستهلكها الجهاز أثناء التبريد."], ["Heating Power Input (قدرة دخل التدفئة)", "heatingPower", "Heating Power Input", "القدرة الكهربائية التي يستهلكها الجهاز أثناء التدفئة."], ["Power Input / Input Power (القدرة)", "power", "Power Input / Input Power", "القدرة الكهربائية الداخلة إلى الجهاز، وتقاس بالواط أو الكيلوواط."], ["EER (كفاءة الطاقة في التبريد)", "eer", "EER", "نسبة كفاءة التبريد؛ كلما زادت عادةً كان استهلاك التبريد أفضل."], ["COP (معامل أداء التدفئة)", "cop", "COP", "معامل أداء التدفئة؛ يقارن قدرة التدفئة بالطاقة الكهربائية المستهلكة."],
  ["Refrigerant Charge / Quantity (وزن الشحنة)", "charge", "Refrigerant Charge / Quantity", "كمية الفريون داخل النظام، وتقاس غالبًا بالجرام أو الكيلوجرام."], ["Max Operating Pressure / Max Pressure (ضغط التشغيل الأقصى)", "maxPressure", "Max Operating Pressure / Max Pressure", "أقصى ضغط تصميمي أو مسموح به، وقد يذكر لضغطي الطرد والسحب."], ["IP Rating / Water Proof (درجة الحماية IP)", "ipRating", "IP Rating / Water Proof", "درجة حماية جسم الجهاز من الماء والأجسام الصلبة، مثل IPX4."], ["Indoor Unit Weight (وزن الوحدة الداخلية)", "indoorWeight", "Indoor Unit Weight", "وزن الوحدة الداخلية."], ["Outdoor Unit Weight (وزن الوحدة الخارجية)", "outdoorWeight", "Outdoor Unit Weight", "وزن الوحدة الخارجية."],
] as const;
