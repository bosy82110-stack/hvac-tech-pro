...
export const fieldDiagnosisGuides: FieldDiagnosisGuide[] = [
  {
    ...
    title: "ضغط السحب منخفض والأمبير منخفض",
    english: "Low Suction Pressure + Low Amp Draw",
    category: "الضغط والأمبير",
    causes: [
      "فلتر الوحدة الداخلية متسخ",
      "المبخر متسخ أو مجرى الهواء ضعيف",
      "بلور الوحدة الداخلية غير نظيف أو مكسور",
      "عطل في كابستور أو موتور البلور",
      "نقص شحنة الفريون أو وجود تسريب",
      "وجود ثلج على ماسورة الطرد قد يدل على نقص فريون",
      "وجود ثلج على ماسورة الراجع قد يدل على عطل أو ضعف مروحة الوحدة الداخلية",
    ],
    steps: [
      "نظف الفلتر والمبخر وتأكد من سريان الهواء داخل الوحدة الداخلية",
      "افحص البلور وموتور المروحة والكابستور، واستبدل الجزء التالف",
      "افحص الدائرة ضد التسريب ثم أصلح التسريب واعمل فاكيوم كامل",
      "اضبط شحنة الفريون حسب وزن الجهاز وقراءات التشغيل بعد استقرار الحمل",
    ],
  },
  {
    id: "high-suction-high-amp",
    title: "ضغط السحب مرتفع والأمبير مرتفع",
    english: "High Suction Pressure + High Amp Draw",
    category: "الضغط والأمبير",
    causes: [
      "اتساخ المكثف أو ضعف التهوية حول الوحدة الخارجية",
      "مروحة الوحدة الخارجية ضعيفة أو سرعتها غير صحيحة",
      "انخفاض أو عدم استقرار التيار الكهربائي",
      "وجود هواء أو غازات غير قابلة للتكثيف داخل دائرة الفريون",
      "زيادة شحنة الفريون عن الكمية المقررة",
      "انسداد أو اتساخ الفلاتر مما يرفع الحمل على الجهاز",
    ],
    steps: [
      "اغسل المكثف ونظف الزعانف واترك مسافات تهوية كافية حول الوحدة الخارجية",
      "افحص موتور مروحة الوحدة الخارجية والكابستور وسرعة الدوران",
      "قس الفولت والأمبير أثناء التشغيل وتأكد من ثبات مصدر التغذية",
      "استرجع الشحنة الزائدة، ثم اعمل فاكيوم واشحن بالوزن طبقًا لبيانات الجهاز",
      "نظف الفلاتر وافحص الحمل ودرجة حرارة الهواء قبل اعتماد النتيجة",
    ],
  },
  {
    id: "low-suction-high-amp",
    title: "ضغط السحب منخفض والأمبير مرتفع",
    english: "Low Suction Pressure + High Amp Draw",
    category: "الضغط والأمبير",
    causes: [
      "انسداد جزئي في الكابلاري أو الفلتر دراير",
      "تقييد في خط السائل أو ثني في المواسير",
      "نقص شحنة بسبب تسريب مع ارتفاع حمل الضاغط",
    ],
    steps: [
      "افحص فرق الحرارة قبل وبعد الفلتر دراير والكابلاري لتحديد مكان التقييد",
      "افحص المواسير للتأكد من عدم وجود انبعاج أو التواء أو انسداد",
      "أصلح سبب التسريب، واستبدل الفلتر دراير أو الجزء المسدود عند الحاجة",
      "اعمل فاكيوم كامل ثم اشحن الفريون بالوزن وراجع الأمبير والضغوط",
    ],
  },
  {
